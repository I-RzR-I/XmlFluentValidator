    ...
    <RelatedItemId2 xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xsi:nil=""false"" />
            ...
            var validator = new XmlValidator("Order")
                ...
                .ForPath("Order/Customer/Address/PostalCode")
                    .WithElementRequired()
                    .WithElementValueRequired()
                    .WithElementDocumentation("Postal code must completed!")
                .Done()
                ...
                .ForPath("Order/Items/Item/ItemID")
                    ...
                    .WithAttributeDocumentation("sku", "SKU must have min 4 characters!")
                .Done()
                ...
                .ForPath("Order/Payment/Method")
                    ...
                    .WithElementDocumentation("Payment method must be in enum!")
                .Done()
