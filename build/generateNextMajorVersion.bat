...
set applicationName=XmlFluentValidator
...
set packResultPath=$('..\nuget\')
set packProjectsPath=$('..\src\XmlFluentValidator\XmlFluentValidator.csproj')
set testProjectsPath=$('..\src\tests\XmlValidatorTests\XmlValidatorTests.csproj')
